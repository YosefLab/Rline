...
g++ -lm -pthread -Wall -Wno-unused-result line.cpp -o line -lgsl -lm -lgslcblas
g++ -lm -pthread -Wall -Wno-unused-result reconstruct.cpp -o reconstruct
g++ -lm -pthread -Wall -Wno-unused-result normalize.cpp -o normalize
g++ -lm -pthread -Wall -Wno-unused-result concatenate.cpp -o concatenate
