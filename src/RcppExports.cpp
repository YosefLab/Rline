...
// line_caller
Rcpp::DataFrame line_caller(Rcpp::StringVector input_u, Rcpp::StringVector input_v, Rcpp::NumericVector input_w, int binary, int dim, int order, int negative, int samples, float rho, int threads);
