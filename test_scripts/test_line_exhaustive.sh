...
binary=("0" "0" "0" "0" "0" "0")
dim=("100" "1" "10" "100" "1" "10")
order=("2" "1" "2" "1" "2" "1")
negative=("5" "1" "5" "25" "1" "5")
sample=("1" "5" "25" "1" "5" "25")
rho=("0.025" "0.001" "0.01" "0.05" "0.1" "0.5")
threads=("1" "1" "1" "1" "1" "1")
test_cases=6
passed_cases=0
...
do 
	cmd="./train_line.sh ${binary[$i-1]} ${dim[$i-1]} ${order[$i-1]} ${negative[$i-1]}
